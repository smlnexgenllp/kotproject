    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white shadow-xl border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          ...
          <button
            onClick={() => setActiveSection("food-menu")}
            className={`w-full flex items-center px-4 py-3 text-left font-medium rounded-lg transition ${
              activeSection === "food-menu"
                ? "text-indigo-600 bg-indigo-50 border-r-4 border-indigo-600"
                : "text-gray-700 hover:bg-gray-50"
            }`}
          >
    ...
    <>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-800">Recent KOTs</h3>
        ...
        {kots.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="mt-4 text-gray-500">No KOTs found</p>
            <p className="text-sm text-gray-400">Orders will appear here when created</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 px-4 font-semibold text-gray-600">Table</th>
              ...
              <tbody>
                {kots.slice(0, 10).map((kot) => (
                  <tr key={kot.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium">Table {kot.table_number}</td>
